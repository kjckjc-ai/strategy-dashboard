...
if selected_trust:
    ...
    with st.expander("Filters"):
        cols = st.columns(3)
        phases = trust_schools_all['PhaseOfEducation (name)'].dropna().unique()
        genders = trust_schools_all['Gender (name)'].dropna().unique()
        religions = trust_schools_all['ReligiousCharacter (name)'].dropna().unique()
